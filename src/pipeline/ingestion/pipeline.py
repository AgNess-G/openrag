...
from pipeline.ingestion.types import FileMetadata, PipelineResult
from utils.logging_config import get_logger

logger = get_logger(__name__)

if TYPE_CHECKING:
    from pipeline.ingestion.chunkers.base import Chunker
    from pipeline.ingestion.config import PipelineConfig
    from pipeline.ingestion.embedders.base import Embedder
    from pipeline.ingestion.indexers.base import Indexer
    from pipeline.ingestion.parsers.base import DocumentParser
    from pipeline.ingestion.preprocessors.base import Preprocessor
    from pipeline.ingestion.registry import IngestionRegistry
...
class PipelineBuilder:
    ...
    def __init__(self, config: PipelineConfig, registry: IngestionRegistry) -> None:
        self._config = config
